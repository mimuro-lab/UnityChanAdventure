...
shared_ptr<Animation> AnimationSwitchBullet::switchingAnimation(characterAction next, Status nowStatus)
{
	using namespace std;
	...
	case characterAction::Brake:
		...
		retObj = make_shared <Animation>(ImagePath_Object::getIns()->bulletNormal, nowStatus, 0, 0, 6, 99, true, 0.2);
		break;
